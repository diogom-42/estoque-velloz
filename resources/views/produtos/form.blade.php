<div class="form-group {{ $errors->has('serial') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="serial" type="text" id="serial" value="{{ $editpage->serial }}"  >
...
<div class="form-group {{ $errors->has('smart') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="smart" type="text" id="smart" value="{{ $editpage->smart }}"   >
    {!! $errors->first('smart', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('modelo') ? 'has-error' : ''}}">
    <label for="modelo" class="control-label">{{ 'Modelo' }}</label>
    <input class="form-control" name="modelo" type="text" id="modelo" value="{{ $editpage->modelo }}" >
    {!! $errors->first('modelo', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('categoria') ? 'has-error' : ''}}">
    <label for="categoria" class="control-label">{{ 'Categoria' }}</label>
    <input class="form-control" name="categoria" type="text" id="categoria" value="{{ $editpage->categoria }}" >
...
<div class="form-group {{ $errors->has('qtd') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="qtd" type="text" id="qtd" value="{{ $editpage->qtd }}" >
...
<div class="form-group {{ $errors->has('nf') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="nf" type="text" id="nf" value="{{ $editpage->nf }}" >
    {!! $errors->first('nf', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('status') ? 'has-error' : ''}}">
    <label for="status" class="control-label">{{ 'Status' }}</label>
    <input class="form-control" name="status" type="text" id="status" value="{{ $editpage->status }}" >
...
<div class="form-group {{ $errors->has('dataRecebimento') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="dataRecebimento" type="text" id="dataRecebimento" value="{{ $editpage->dataRecebimento }}" >
