...
<div class="form-group {{ $errors->has('nome') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="nome" type="text" id="nome" value="{{ $editpage->nome }}">
...
<div class="form-group {{ $errors->has('celular') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="celular" type="text" id="celular" value="{{ $editpage->celular }}">
...
<div class="form-group {{ $errors->has('cpf') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="cpf" type="text" id="cpf" value="{{ $editpage->cpf }}">
...
<div class="form-group {{ $errors->has('uf') ? 'has-error' : ''}}">
    ...
    <select class="form-control" name="uf" type="text" id="uf" value="{{ $editpage->uf }}"  >
...
<div class="form-group {{ $errors->has('ativo') ? 'has-error' : ''}}">
    ...
    <select class="form-control" name="ativo" type="text" id="ativo" value="{{ $editpage->ativo }}" >
